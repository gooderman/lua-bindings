...
public:
    ...
    static int encryptAES256Lua(const char* plaintext,
                                       int plaintextLength,
                                       const char* key,
                                       int keyLength)
    {
    ...
    static int decryptAES256Lua(const char* ciphertext,
                                       int ciphertextLength,
                                       const char* key,
                                       int keyLength)
    {
    ...
    static int MD5Lua(const char* input, bool isRawOutput);
...
private:
    ...
    static int cryptAES256Lua(bool isDecrypt,
                                     const char* input,
                                     int inputLength,
                                     const char* key,
                                     int keyLength);
